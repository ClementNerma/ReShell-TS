...
export type NativeLibraryFnNames = 'ok' | 'err' | 'echo' | 'dump' | 'trace' | 'ls'
    ...
    args: _forgeTokens([
      {
        ...
        optional: false,
        defaultValue: null,
        type: { type: 'generic', name: _forgeToken('T'), orig: nativeLibAt('ok:T') },
      },
    ]),
    restArg: null,
    ...
    args: _forgeTokens([
      {
        ...
        optional: false,
        defaultValue: null,
        type: { type: 'generic', name: _forgeToken('E'), orig: nativeLibAt('err:E') },
      },
    ]),
    restArg: null,
    returnType: _forgeToken({
